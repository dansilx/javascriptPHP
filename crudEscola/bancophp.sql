...
INSERT INTO `professor` (`id`, `idade`) VALUES
(1, 'Categoria 1'),
(2, 'Categoria 2'),
(3, 'Categoria 3');
...
INSERT INTO `produto` (`id`, `nome`, `idade`, `serie`, `categoria_id`) VALUES
...
ALTER TABLE `aluno`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_aluno_categoria_idx` (`categoria_id`);
